...
rooms[0].portals = [
  Portal.new(name: "not a wooden door", destination: rooms[1]),
  Portal.new(name: "not a wooden door", destination: rooms[2])
]
...
# ]
rooms[1].portals = [
  Portal.new(name: "not a wooden door", destination: rooms[3]),
  Portal.new(name: "not a wooden door", destination: rooms[4])
]
...
rooms[2].portals = [
  Portal.new(name: "not a wooden door", destination: rooms[0]),
  Portal.new(name: "not a wooden door", destination: rooms[5])
]
